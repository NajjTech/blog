...
<div class="br-sideleft overflow-y-auto">
    ...
    <div class="br-sideleft-menu">
        ...
        <a href="{{url('/admin/features')}}" class="br-menu-link">
            <div class="br-menu-item">
                <i class="menu-item-icon fa fa-key tx-22"></i>
                <ion-icon name="bug"></ion-icon>
        ...
        <a href="{{url('/admin/gallery')}}" class="br-menu-link">
            <div class="br-menu-item">
                <i class="menu-item-icon fa fa-image tx-22"></i>
                <ion-icon name="bug"></ion-icon>
        ...
        <a href="{{url('/admin/team')}}" class="br-menu-link">
            <div class="br-menu-item">
